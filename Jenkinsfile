...
"""
  ...
  environment {
    ...
    DEVCLOUD_REGISTRY_ADDRESS = "docker-nexus-mgt-technical-review.perspectatechdemos.com"
    ...
    MATTERMOST_WEBHOOK = "https://mattermost-mgt-technical-review.perspectatechdemos.com/hooks/y3aws9x3p7yqpfa7ckxkijcbsr"
    ...
    DEV_DEPLOYMENT_URL = "http://griffincollege-spring-petclinic-dev.apps.technical-review.perspectatechdemos.com"
    TEST_DEPLOYMENT_URL = "http://griffincollege-spring-petclinic-test.apps.technical-review.perspectatechdemos.com"
    PROD_DEPLOYMENT_URL = "http://griffincollege-spring-petclinic-prod.apps.technical-review.perspectatechdemos.com"
  }
